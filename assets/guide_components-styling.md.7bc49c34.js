...
</code></pre></div><h3 id="contitional-styling" tabindex="-1">Contitional Styling <a class="header-anchor" href="#contitional-styling" aria-hidden="true">#</a></h3><p>You can use the <code>ternary</code> operator to conditionally render properties inside <code>css</code>.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token keyword">import</span> Minze<span class="token punctuation">,</span> <span class="token punctuation">{</span> MinzeElement <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
