...
</code></pre></div><h3 id="contitional-attributes" tabindex="-1">Contitional Attributes <a class="header-anchor" href="#contitional-attributes" aria-hidden="true">#</a></h3><p>Conditional rendering can also be used for attributes.</p><p><strong>Example</strong></p><div class="language-js"><pre><code><span class="token keyword">import</span> Minze<span class="token punctuation">,</span> <span class="token punctuation">{</span> MinzeElement <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;minze&#39;</span>
